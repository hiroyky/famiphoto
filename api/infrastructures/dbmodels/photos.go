...
var (
	photoAllColumns            = []string{"photo_id", "name", "imported_at", "created_at", "updated_at", "file_name_hash", "description_en", "description_ja"}
	photoColumnsWithoutDefault = []string{"name", "imported_at", "created_at", "updated_at", "file_name_hash", "description_en", "description_ja"}
...
func (photoL) LoadExifs(ctx context.Context, e boil.ContextExecutor, singular bool, maybePhoto interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`exif`),
		qm.WhereIn(`exif.photo_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (photoL) LoadPhotoFiles(ctx context.Context, e boil.ContextExecutor, singular bool, maybePhoto interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`photo_files`),
		qm.WhereIn(`photo_files.photo_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (photoL) LoadPhotoThumbnails(ctx context.Context, e boil.ContextExecutor, singular bool, maybePhoto interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`photo_thumbnails.photo_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
