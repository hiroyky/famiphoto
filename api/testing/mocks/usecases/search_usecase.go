...
func (m *MockSearchUseCase) SearchPhotos(ctx context.Context, id, year, month, date *int, limit, offset int) (*entities.PhotoSearchResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchPhotos", ctx, id, year, month, date, limit, offset)
...
func (mr *MockSearchUseCaseMockRecorder) SearchPhotos(ctx, id, year, month, date, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchPhotos", reflect.TypeOf((*MockSearchUseCase)(nil).SearchPhotos), ctx, id, year, month, date, limit, offset)
}
