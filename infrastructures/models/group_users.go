...
func (o *GroupUser) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for group_users")
	}
...
func (o *GroupUser) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for group_users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for group_users")
	}
