...
var (
	photoAllColumns            = []string{"photo_id", "name", "imported_at", "created_at", "updated_at", "file_name_hash"}
	photoColumnsWithoutDefault = []string{"name", "imported_at", "created_at", "updated_at", "file_name_hash"}
