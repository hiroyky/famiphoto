...
var PhotoThumbnailTableColumns = struct {
	...
	GroupID:       "photo_thumbnails.group_id",
	OwnerID:       "photo_thumbnails.owner_id",
}
...
var PhotoThumbnailWhere = struct {
	...
	GroupID:       whereHelperstring{field: "`photo_thumbnails`.`group_id`"},
	OwnerID:       whereHelperstring{field: "`photo_thumbnails`.`owner_id`"},
}
...
func (r *photoThumbnailR) GetGroup() *Group {
	if r == nil {
		return nil
	}
	return r.Group
...
func (r *photoThumbnailR) GetOwner() *User {
	if r == nil {
		return nil
	}
	return r.Owner
...
var (
	photoThumbnailAllColumns            = []string{"photo_id", "thumbnail_name", "file_path", "created_at", "updated_at", "group_id", "owner_id"}
	photoThumbnailColumnsWithoutDefault = []string{"photo_id", "thumbnail_name", "file_path", "group_id", "owner_id"}
...
func (o *PhotoThumbnail) Group(mods ...qm.QueryMod) groupQuery {
	queryMods := []qm.QueryMod{
...
func (o *PhotoThumbnail) Owner(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
func (photoThumbnailL) LoadPhoto(ctx context.Context, e boil.ContextExecutor, singular bool, maybePhotoThumbnail interface{}, mods queries.Applicator) error {
	...
	if singular {
		object = maybePhotoThumbnail.(*PhotoThumbnail)
	} else {
		slice = *maybePhotoThumbnail.(*[]*PhotoThumbnail)
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (photoThumbnailL) LoadGroup(ctx context.Context, e boil.ContextExecutor, singular bool, maybePhotoThumbnail interface{}, mods queries.Applicator) error {
	var slice []*PhotoThumbnail
	var object *PhotoThumbnail
...
// loaded structs of the objects. This is for an N-1 relationship.
func (photoThumbnailL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybePhotoThumbnail interface{}, mods queries.Applicator) error {
	var slice []*PhotoThumbnail
	var object *PhotoThumbnail
	...
	if singular {
		...
		foreign.R.OwnerPhotoThumbnails = append(foreign.R.OwnerPhotoThumbnails, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.OwnerID == foreign.UserID {
				...
				foreign.R.OwnerPhotoThumbnails = append(foreign.R.OwnerPhotoThumbnails, local)
				break
			}
		}
	}
...
// SetGroup of the photoThumbnail to the related item.
// Sets o.R.Group to related.
// Adds o to related.R.PhotoThumbnails.
func (o *PhotoThumbnail) SetGroup(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Group) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.GroupID, o.PhotoID, o.ThumbnailName}
...
// SetOwner of the photoThumbnail to the related item.
// Sets o.R.Owner to related.
// Adds o to related.R.OwnerPhotoThumbnails.
func (o *PhotoThumbnail) SetOwner(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.UserID, o.PhotoID, o.ThumbnailName}
	...
	if related.R == nil {
		related.R = &userR{
			OwnerPhotoThumbnails: PhotoThumbnailSlice{o},
		}
	} else {
		related.R.OwnerPhotoThumbnails = append(related.R.OwnerPhotoThumbnails, o)
	}
